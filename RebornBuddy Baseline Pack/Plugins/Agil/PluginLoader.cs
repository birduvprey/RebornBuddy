...
namespace Agil
{
    public class PluginLoader : BotPlugin
    {
        ...
        private const string ProjectName = "Agil";
        private const string ProjectMainType = "Agil.AgilPlugin";
        private const string ProjectAssemblyName = "Agil.dll";
        private static readonly Color logColor = Color.FromRgb(109, 139, 225);
        public override string Description => "Equipment repair and optimizer.";
        public override string Author => "Saga";
