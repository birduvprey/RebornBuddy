...
namespace ArcadeLoader
{
    public class BotBaseLoader : BotBase
    {
        // Change this settings to reflect your project!
        private const string ProjectName = "Arcade";
        private const int ProjectId = 24;
        private const string ProjectMainType = "Arcade.Arcade";
        private const string ProjectAssemblyName = "Arcade.dll";
        private static readonly Color logColor = Colors.DodgerBlue;
